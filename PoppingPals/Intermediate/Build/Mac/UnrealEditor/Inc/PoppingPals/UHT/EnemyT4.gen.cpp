...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemyT4_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "EnemyT4.h" },
		{ "ModuleRelativePath", "EnemyT4.h" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AEnemyT4_Statics::NewProp_enemyClass = { "enemyClass", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AEnemyT4, enemyClass), Z_Construct_UClass_UClass, Z_Construct_UClass_AEnemyT3_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEnemyT4_Statics::NewProp_enemyClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemyT4_Statics::NewProp_enemyClass_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AEnemyT4_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AEnemyT4_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemyT4_Statics::Class_MetaDataParams))
	};
	...
	AEnemyT4::~AEnemyT4() {}
	struct Z_CompiledInDeferFile_FID_marco_capraro_Documents_GitHub_Popping_Pals_PoppingPals_Source_PoppingPals_EnemyT4_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_marco_capraro_Documents_GitHub_Popping_Pals_PoppingPals_Source_PoppingPals_EnemyT4_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AEnemyT4, AEnemyT4::StaticClass, TEXT("AEnemyT4"), &Z_Registration_Info_UClass_AEnemyT4, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEnemyT4), 1193134643U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_marco_capraro_Documents_GitHub_Popping_Pals_PoppingPals_Source_PoppingPals_EnemyT4_h_2579159978(TEXT("/Script/PoppingPals"),
		Z_CompiledInDeferFile_FID_marco_capraro_Documents_GitHub_Popping_Pals_PoppingPals_Source_PoppingPals_EnemyT4_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_marco_capraro_Documents_GitHub_Popping_Pals_PoppingPals_Source_PoppingPals_EnemyT4_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
